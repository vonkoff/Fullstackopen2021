...
const App = () => {
  ...
  //Proof of concept
  console.log("current idx: ", selected)
  console.log("Highest vote: ",Math.max(...voted));
  console.log("idx with Highest vote: ", voted.indexOf(Math.max(...voted)));

  const mostvotes = voted.indexOf(Math.max(...voted))
  ...
  return (
    ...
    <h1>Anecdote of the day</h1>
      ...
      <br/>
      <Button handleClick={randSelect} text="Random"/>
